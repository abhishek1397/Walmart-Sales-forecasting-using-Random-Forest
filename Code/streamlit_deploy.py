...
# --- Footer ---
st.markdown("---")
st.caption("Made by Abhishek Sharma | © 2026 Sales AI")
st.markdown("🔗 View Source Code on [GitHub](https://github.com/abhishek1397/Walmart-Sales-Forecasting-Web-App-using-Holt-Winters)")
